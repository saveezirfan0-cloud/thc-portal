...
/**
 * ADR-0046 (docs/19 §4). The offer machine exists twice —
...
describe('takeOffer — the order take_offered_shift() checks in', () => {
  ...
  it('with auto-assign off, wave 2 takes at once (RULE-17 deadlock, ADR-0046 review fixes)', () => {
  ...
  it('the calendar never refuses a take (ADR-0043)', () => {
