...
/**
 * A share code as the database stores it: nine letters and digits, upper
 * case, with gov.uk's spaces and dashes removed. Null when it is not one.
 */
...
/** "W98 7ZY 6XK" — how gov.uk prints it and how the worker reads it back. */
