 ...
 *            rename yourself on /account (ADR-0055)
 ...
 *            the office's /users, set up on the portal (ADR-0055; drives
 *            both servers)
 *
  ...
  webServer: [
    {
      ...
      // (ADR-0055), read from NEXT_PUBLIC_CLIENT_URL. `next start` runs as
