...
Status: accepted · 26.09.2026 · 20260927140000, 20260927140300, 20260927160500, 20260927160600, 20260927161200 · §1 and §3 amended 29.09.2026 by 20260929100000 (ADR-0030)
...
- **N7** from **09:00 Europe/London on the day, or two hours before the start
  ...
  exactly 00:00 UK gets no N7 (ADR-0030 §2). Not to a booking already checked
...
`mark_ready()` refuses a press at the deadline (ADR-0030 §3–4).
