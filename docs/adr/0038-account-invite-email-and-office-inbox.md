# ADR-0038 · The account invitation email (E11), and the office Inbox
...
- `20260930120000_account_invite_email.sql`; `supabase/tests/652_account_invite_email.sql`; `packages/notifications/src/{templates,inbox}.ts` and their tests; `apps/office/app/inbox/**`; `apps/office/app/_lib/inviteEmail.ts`.
