...
| `/client/events/:id` | Event page + feedback popup. Additions: Add to calendar (.ics, hidden when cancelled, ADR-0035), "N of M arrived" in the header and per role while ongoing (ADR-0038) | `client/event.html` | 11.2, 11.5 | client-portal |
