 ...
 * (`wireframes/client/login.html:65,85,126`, ADR-0032): a real checkbox, ticked by default; the sign-in obeys it; the
  ...
  createServerClient: (
    ...
    auth: {
      getUser: async () => {
        ...
        return { data: { user: { app_metadata: { role: 'client' } } } };
      },
    },
  }),
}));
...
describe('the control (login.html:65, 85, 126)', () => {
