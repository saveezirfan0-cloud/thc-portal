...
export const metadata: Metadata = {
  ...
  // rather than a side effect of a file's existence (ADR-0037).
  ...
  // of the brand and the account menu (ADR-0037 §4).
...
export const viewport: Viewport = {
  ...
  // query follows the OS setting, not the in-app switch (ADR-0037 §3).
  themeColor: [
