...
/**
 * Where a Back Office invitation from /users lands (ADR-0035). Opening the
...
export default async function Page({
  ...
  if (!isActivationToken(token)) {
    return (
      <AuthCard product="Back Office" heading="This link is incomplete">
        <Alert tone="coral">
  ...
  return (
    <AuthCard product="Back Office" heading="Set up your login">
      <p className="sm muted">
        You have been given a login to the THC Back Office. Choose a password to finish.
      </p>
