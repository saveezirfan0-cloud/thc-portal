 ...
 * the /staff/:id banner — ADR-0038, `wireframes/backoffice/change-requests.html`.
...
/** Pending first-come first-served (ADR-0038): oldest first. */
 ...
 * has no evidence to tick (ADR-0038 §3). The server action asks again.
 */
