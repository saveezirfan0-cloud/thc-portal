...
describe('Emergency contact card (ADR-0037)', () => {
...
describe('Referrals card (ADR-0040)', () => {
...
describe('Availability tab (ADR-0036)', () => {
...
describe('Pending change-request banner (ADR-0038)', () => {
  const request = {
    id: 'r1',
    staff_id: 's1',
    kind: 'name',
