 ...
 * first paint must be UK, with the reader's zone arriving on mount.
 */
...
describe('the detail window (§9.5)', () => {
  it('carries the "Flagged as" line and the stamps as actual instants', () => {
    ...
    // Viewer-local ("your time"), UK on the first paint.
    expect(html).toContain('17 Sep, 16:58 your time');
    expect(html).toContain('17 Sep, 20:48 your time');
