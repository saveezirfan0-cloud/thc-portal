 ...
 * is a slash — to https://evil.com/. A worker who has just typed their
 * password into the genuine THC domain would be delivered to an attacker's
 * page. apps/staff/app/auth/callback/route.ts says why that matters for an
 * emailed link; a `/login?next=` link in an email is the same kit.
 *
