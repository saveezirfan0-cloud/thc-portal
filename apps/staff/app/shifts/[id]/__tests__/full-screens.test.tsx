...
const { NoOnSiteFixScreen, OffSiteCheckOutScreen, TurnedAwayScreen } =
  await import('../FullScreens');
...
describe('(m) buffer turn-away', () => {
  it('has "OK, I understand" back to Shifts and "Open Radar"', () => {
    const html = renderToStaticMarkup(<TurnedAwayScreen paid />);
