...
import { NO_ON_SITE_FIX, checkedOutOffSiteMessage, turnedAwayMessage } from './messages';
...
/** (m) §3.2 / RULE-15 — strict buffer, the shift was already fully staffed. */
export function TurnedAwayScreen({ paid }: { paid: boolean }) {
  return (
