...
select is(submit_document_upload('share_code_report', null, 'A98 7ZY 6XK')->>'reason', 'share_code_invalid',
  'nine characters are not enough: a share code starts with W, the same is_valid_share_code() the wizard uses (20260923192000)');
