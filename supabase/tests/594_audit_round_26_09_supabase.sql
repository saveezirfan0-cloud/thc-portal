...
select is((select count(*)::int from notification_outbox where key = 'N15:declaration:' || :'c_emp'), 1,
  '§10.7 and N15 "your shifts are open again" goes out NOW, keyed on the accepted declaration — once (20260927161100)');
