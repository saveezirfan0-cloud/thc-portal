-- =====================================================================
-- 673 · The hourly offer rounds and the lapse (ADR-0039, ADR-0036)
...
insert into client_qualifications (client_id, role_id, staff_id) values
  ...
  (:'clientb', :'role_id', :'off');
-- Quin Away has marked the section's day unavailable (ADR-0036).
...
select is(notify_offer_candidates(:'o', array[:'off'::uuid, :'blk'::uuid, :'qa'::uuid]), 0,
  'C: never the offerer, a blocked worker, or one marked unavailable (ADR-0036)');
