-- =====================================================================
-- 673 · RULE-20: one cap per week, a visa's own hours limit, and the
--       course level the office confirms (audit D35, D36, D32)
--   20260930130000_cap_band_visa_limit.sql
--   20260930130100_cap_week_visa_limit_and_course_level.sql
--
