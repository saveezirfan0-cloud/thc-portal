-- =====================================================================
-- 626 · The shift screen knows a Left early is logged (RULE-14)
--   20260929130100_staff_shift_detail_left_early.sql
--
-- check_out() raises `left_early` (20260929120000). A logged Left early
...
\set sh_le   'c6260000-0000-4000-8000-000000000011'
\set b_le    'c6260000-0000-4000-8000-000000000021'
...
set local role authenticated;
select is_empty($$ select * from staff_shift_detail('c6260000-0000-4000-8000-000000000021') $$,
