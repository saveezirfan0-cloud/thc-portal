-- =====================================================================
-- 630 · §1.7 GDPR removal reaches every copy of the person (audit D9)
--   remove_worker() from 20260929140100_gdpr_removal_scrubs_the_rest.sql
--
...
insert into notification_outbox (key, channel, template, recipient_staff_id, recipient_emails, payload, sent_at) values
  ...
  ('X:free:630', 'email', 'E7', null, array['admin@thehospitalitycompany.co.uk'],
...
select is((select payload from notification_outbox where key = 'X:free:630'),
  '{"label": "Deleted account #96301", "gdprRemoved": true}'::jsonb,
