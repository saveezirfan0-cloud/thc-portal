...
select is_empty(
  ...
  'worked and turned_away are terminal (§3.6: No check-out is a branch of worked, not a state); cancelled leaves only by a reopen to invited/applied, never a self-cancel (20260930110100, ADR-0037)');
