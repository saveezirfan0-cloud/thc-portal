-- =====================================================================
-- 661 · The office's emergency contact, and the other /staff/:id reads
--   20260930130000_office_staff_additions.sql · docs/18 §1, §2, §5
--   ADR-0036, ADR-0037, ADR-0040
--
...
-- RPCs (docs/18 §8: C tests with owner-inserted fixtures).
-- =====================================================================
begin;
select plan(41);
...
select is(
  ...
  1, 'B: one audit_log row naming the manager (docs/18 §0.3)');
select is(
...
-- =====================================================================
-- E · office_staff_unavailability (ADR-0036, RULE-18)
-- =====================================================================
...
-- =====================================================================
-- F · office_staff_referrals (ADR-0040)
-- =====================================================================
