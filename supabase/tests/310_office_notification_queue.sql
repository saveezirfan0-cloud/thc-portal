...
select bag_eq(
  ...
  'and the fix did NOT add an insert policy: the table carries admin_read and the restrictive E11 (20260930210600) and E3 (20260930220200) read fences — all select only');
