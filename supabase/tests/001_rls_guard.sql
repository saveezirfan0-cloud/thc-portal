...
-- ---------------------------------------------------------------------
--    20260926110000 (ADR-0026) dropped the last two — client_events on
...
--     and in no migration; 20260926110900 drops it wherever it is found.
select hasnt_function('public', 'rls_auto_enable',
  'no unowned rls_auto_enable() definer exists (20260926110900 drops the live-only one)');
