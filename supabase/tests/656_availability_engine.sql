-- =====================================================================
-- 656 · Availability in auto-assign (ADR-0036, docs/18 §1, Agent A)
--   20260930110000_availability_in_auto_assign.sql
--
...
-- The calendar (ADR-0036), built the way the Staff App builds it.
