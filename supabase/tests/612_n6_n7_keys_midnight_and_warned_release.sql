...
--       without N6
--   20260929100000_confirmation_timers_restated.sql (ADR-0030; audit D26,
--   D25's retry)
--
...
select is(n7_closes_at('2026-02-12 00:00+00'), n7_due_at('2026-02-12 00:00+00'),
  'a section starting at exactly 00:00 has no N7 window: no moment of its UK day comes before it (ADR-0030)');
