-- =====================================================================
-- 746 · E11 set-up links: owners only, and gone once sent (20261001200600)
--
-- The QA review of ADR-0055…0038 found a manager or scheduler could read
...
-- The fixture admin is an owner (20261001200100's insert trigger).
