...
-- (20260930200100: shift_offers, shift_offer_notices, the state guard,
-- cancel cause 'handed_over'; 20260930200000: booking_source 'offer');
...
-- (pgTAP 724, the 592 pattern). A blank note is written as `—`.
--
...
--
-- One function so the six payloads sit side by side and pgTAP 724 can
