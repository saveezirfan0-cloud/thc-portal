...
-- right line when every Back Office login could invite. Since ADR-0056
...
comment on policy office_users_invite_links on notification_outbox is
  'ADR-0058/0036: an E11 row carries a one-time set-up link; only a session with office_can(''users'') (an owner) may read it. 20261001200600.';
