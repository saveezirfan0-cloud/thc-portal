-- =====================================================================
-- Migration 20260930110400 · the client line-up carries its role section
--                            (§11.2, §11.3, RULE-18)
--
...
-- definition verbatim (the latest; 20260927160100 restated only its
-- comment, which is carried forward here with the new column named): owner rights, security barrier, tenancy predicate
