...
-- (20260930200100): admin_read only, no staff or client policy. Recording
-- a referral on /apply is Agent D's (20260930204000); nothing here reads an
