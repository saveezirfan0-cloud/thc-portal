-- =====================================================================
-- Migration 20260930110000 · availability in auto-assign
--   (ADR-0036 Worker availability; docs/18 §1, Phase 1 Agent A, part A1)
--
-- The calendar a worker keeps in the Staff App (staff_unavailability,
-- 20260930100100) becomes a HARD GATE on what the machine does, and
-- advice for people:
--
...
-- SQL pool (auto_assign_candidates, frozen in Phase 1 by docs/18 §0.6) is
...
--       clause.
--
-- pgTAP 656 asserts the new refusal AND every refusal invite_worker made
...
begin
  ...
  -- ADR-0036 (20260930110000): the calendar gates what the MACHINE does.
